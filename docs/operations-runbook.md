...
2. Run `npm run check`.
3. Back up the live files on the VPS before replacing them.
4. Copy only the changed files or deploy the full updated checkout.
5. On the VPS, ensure file ownership remains `tf20:tf20` for app files.
